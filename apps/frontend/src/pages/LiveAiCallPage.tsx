...
export function LiveAiCallPage() {
  ...
  return (
    <>
      <div className="flex w-full items-center justify-between px-margin-mobile pt-6 md:px-margin-desktop">
      ...
      <main className="relative mx-auto grid w-full max-w-container-max flex-grow grid-cols-1 gap-gutter px-margin-mobile pt-6 pb-32 md:px-margin-desktop lg:grid-cols-12">
